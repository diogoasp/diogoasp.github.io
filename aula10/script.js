...
let action1 = document.getElementById('enlace_1');
action1.addEventListener("click", hiddenElements, false);

let action2 = document.getElementById('enlace_2');
action2.addEventListener("click", hiddenElements, false);

let action3 = document.getElementById('enlace_3');
action3.addEventListener("click", hiddenElements, false);
